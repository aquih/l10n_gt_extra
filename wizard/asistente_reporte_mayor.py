...
class AsistenteReporteMayor(models.TransientModel):
    ...
    def print_report_excel(self):
        ...
        for w in self:
            ...
            hoja.write(2, 1, self.env.company.company_id.partner_id.vat)
            hoja.write(3, 0, 'NOMBRE COMERCIAL')
            hoja.write(3, 1, self.env.company.company_id.partner_id.name)
            hoja.write(2, 3, 'DOMICILIO FISCAL')
            hoja.write(2, 4, self.env.company.company_id.partner_id.street)
